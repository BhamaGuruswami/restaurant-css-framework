...
if(isset($_POST) & !empty($_POST)){
 ...
 $updatesql = "UPDATE `contact` SET name = '$name', email = '$email', subject = '$subject', branch = '$branch', gender = '$gender', message = '$message'  WHERE id = $id";
 $res = mysqli_query($conne, $updatesql);
if ($res){
     ...
     <div class="col-md-9 mb-md-0 mb-5">
         <form id="contact-form" name="contact-form" action="" method="POST">
             ...
             <div class="col-md-12">
               <div class="md-form mb-0">
                 ...
                 <select class="form-select " name = "country" aria-label="Default select example">
                   ...
                   <option value="Belgium" <?php if ($r["branch"] =="Belgium"){echo "selected";}  ?>>Belgium</option>
                   <option value="Germany" <?php if ($r["branch"] =="Germany"){echo "selected";}  ?>>Germany</option>
                 </select>
             </div>
             </div>
             </div>
             ...
             <div class="form-check">
               ...
               <label>
               <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="Female" <?php if ($r["gender"] =="Female"){echo "checked";}  ?>>
                 Female
               </label>
             </div>
             <div class="form-check">
               <label>
               <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="Male" <?php if ($r["gender"] =="Male"){echo "checked";}  ?>>
                 Male
               </label>
             </div>
                 </div>
                 ...
                 <div class="col-md-12">
                     <div class="md-form">
                       <label for="message">Your message</label>
                         <input type="text" id="message" name="message" rows="2" class="form-control md-textarea"  value = "<?php echo $r["subject"] ?>">
                     </div>
                 </div>
             </div>
             <!--Grid row-->
